...
class ClientNaiveAgent(Thread):
    ...
    def run(self):
        ...
        levels = self.update_no_of_levels()
    ...
    def _updateReader(self,dtype):
        ...
        try:
            ...
            try:
                ...
                while True:
                    print('{} : state is not vaild, try request game state agains in 2 sec...'.format(datetime.fromtimestamp(time.time())))
                    time.sleep(2)
